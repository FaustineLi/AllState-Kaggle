...
```{r, echo=FALSE}
res = readRDS('writeup//res_extra_feat.RDS')
...
```{r, echo=FALSE}
library('ggplot2')
grid1 = readRDS('writeup//grid_result.RDS')
...
```{r, echo=FALSE}
grid2 = readRDS('writeup//grid_result_child.RDS')
...
```{r, echo=FALSE}
grid3 = readRDS('writeup//grid_result_samp.RDS')
...
lines(x, abs)
legend('topright', c('squared loss', 'absolute error loss', 'log cosh loss'), col = c(2,1,4), lty=1)
```
...
```{r, echo=FALSE}
importance = readRDS('writeup//feat_import.RDS')
...
```{r, echo=FALSE}
importance_extra = readRDS('writeup//feat_import_extra.RDS')
